...
public class KKMController {
    ...
    @FXML
    private TableColumn<Student, Double> statusColumn;
        ...
        if (selectedFile != null) {
            try {
                ...
                for (int i = 0; i < studentsArray.length(); i++) {
                    ...
                    double alreadyDeposit = studentObject.getDouble("alreadyDeposited");
    ...
    private void handleEdit() {
        ...
        if (selectedStudent != null) {
            ...
            TextField catalogNumberField = new TextField(selectedStudent.getCatalogNumber());
            ...
            dialog.setResultConverter(buttonType -> {
                if (buttonType == ButtonType.OK) {
                    selectedStudent.setCatalogNumber(catalogNumberField.getText());
    ...
    private void initialize() {
        ...
        alreadyDepositColumn.setCellValueFactory(new PropertyValueFactory<>("alreadyDeposit"));
        ...
        haveToDepositColumn.setCellFactory(col -> new TableCell<>() {
            @Override
            protected void updateItem(Double item, boolean empty) {
                super.updateItem(item, empty);
                if (empty || item == null) {
        ...
        statusColumn.setCellValueFactory(new PropertyValueFactory<>("haveToDeposit"));
        statusColumn.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Double item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    ImageView imageView;
                    if (item <= 0) {
                        imageView = new ImageView(new Image(getClass().getResource("DoneIcon.png").toExternalForm()));
                    } else {
                        imageView = new ImageView(new Image(getClass().getResource("CancelIcon.png").toExternalForm()));
                    }
